...
same build across multiple turns instead of starting over. A complete self-sustaining base, drill, furnace, assembler, output, is still in progress. See `roadmap.md` for the current
