...
- [ ] **Gap analysis vs. [AI Player v3](https://mods.factorio.com/mod/ai-player-v3)** (found
  ...
  - Plan: fork/vendor their skill library as an alternative or complementary action layer, keep FLE's raw-code path for flexibility, add their skills as a fallback/primary path when
