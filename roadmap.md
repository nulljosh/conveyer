...
- [ ] **BLOCKED**: Factorio container crash-loops under colima's bind mounts (permission +
      stat errors on its own config files, survives `chmod 777`). See CLAUDE.md "Platform
      gotchas". Try Docker Desktop or a different colima mount type next.
